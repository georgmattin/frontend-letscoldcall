...
export type DeleteListConfirmPopupProps = {
  title?: string;
...
const DeleteListConfirmPopup: React.FC<DeleteListConfirmPopupProps> = ({
  title = "Delete List",
  listName,
  confirmLabel = "Delete",
  cancelLabel = "Cancel",
    ...
    >
      <div className="h-full w-full p-[30px] flex flex-col">
        ...
        <p className="mt-2 text-[16px] text-[#003333]" style={fontStyle}>
          ...
          {" "}
          <span className="font-semibold">“{listName || "this list"}”</span>?
        </p>
...
export default DeleteListConfirmPopup;
