...
interface AISummaryToggleProps extends React.HTMLAttributes<HTMLDivElement> {
...
export default function AISummaryToggle({
  ...
  // Controlled: derive display values from props
  const used = creditsUsed
  const isGenerating = generating
  const text = summary

  // Match AITranscriptionToggle logic
          ...
          {text ? (
            ...
            <div className="mt-2 rounded-[5px] border border-[#0033331a] bg-white p-4 min-h-[155px] max-h-[155px] overflow-auto">
              <div className="text-center">
                <div className="text-[16px] font-semibold text-[#0f3b3b]">AI Call Summary</div>
                <div className="text-[14px] text-[#0f3b3b]/80 mt-1">Generate a concise summary of the call</div>
